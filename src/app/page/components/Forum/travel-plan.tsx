...
import { Calendar, MapPin, Clock, Users, Edit, Share2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold tracking-tight">My Travel Plan</h1>
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              <CardTitle>{mockPlan.title}</CardTitle>
              <div className="mt-2 flex items-center space-x-4 text-sm text-muted-foreground">
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    {Math.ceil(
                      (new Date(mockPlan.endDate).getTime() - new Date(mockPlan.startDate).getTime()) /
                        (1000 * 60 * 60 * 24)
                    )}{" "}
                    days
                  </span>
                ...
                <div className="flex items-center">
                  ...
                  <span>
                    {mockPlan.participants} {mockPlan.participants === 1 ? "person" : "people"}
                  </span>
                </div>
              </div>
            </div>
